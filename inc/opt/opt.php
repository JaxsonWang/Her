...
function BaseSettings() {
	if ( isset( $_POST['update_options'] ) && $_POST['update_options'] == 'true' ) {
		...
		update_option( 'theme_highlight_javascript', isset( $_POST['theme_highlight_javascript'] ) && $_POST['theme_highlight_javascript'] ? $_POST['theme_highlight_javascript'] : '' ); //input
